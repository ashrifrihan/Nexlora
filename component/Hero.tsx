...
const techStack = [
  {
    node: (
      <div className="flex items-center gap-2.5 px-4 py-3 bg-gradient-to-br from-white/[0.08] to-white/[0.02] border border-white/[0.08] rounded-xl backdrop-blur-lg hover:from-white/[0.12] hover:to-white/[0.04] hover:border-white/[0.12] transition-all duration-300 shadow-lg hover:shadow-xl hover:shadow-white/10 select-none group" style={{ fontFamily: '"Satoshi", sans-serif' }}>
      ...
      <div className="relative z-10 w-full px-3 sm:px-4 md:px-8 text-center flex flex-col items-center pt-16 sm:pt-24 md:pt-40">
        ...
        >
          ...
          <div className="relative w-full">
            {/* Subtle gradient background for logo loop */}

...
const services = [
  {
    ...
    desc: "Modern responsive websites, cloud apps, and mobile interfaces built for performance, SEO, and conversion from landing pages to full-stack platforms.",
    accent: "#3b82f6",
    visual: <WebDevVisual />,
  ...
  },
  {
    ...
    desc: "Full-stack multi-tenant SaaS platforms, telemetry dashboards, and cloud infrastructures engineered to scale seamlessly from MVP to enterprise.",
    accent: "#f59e0b",
  ...
  },
  {
    ...
    desc: "Production-ready AI systems, custom LLM pipelines, autonomous multi-agents, and RAG semantic architectures connected to business workflows.",
    accent: "#a855f7",
    visual: <AIVisual />,
  ...
  },
  {
    ...
    desc: "High-velocity MVP engineering sprints and cross-platform apps for ambitious startups across Sri Lanka, GCC (Saudi Arabia, UAE), and globally.",
    accent: "#10b981",
    visual: <MobileVisual />,
    colSpan: "md:col-span-4 col-span-12",
  },
  {
    id: "ui-ux-design",
    title: "UI/UX Design & Digital Product Engineering",
    desc: "Research-driven user experiences, component design systems, and modern interface patterns that users love.",
    accent: "#ec4899",
    visual: <UIUXVisual />,
    colSpan: "md:col-span-4 col-span-12",
  },
  {
    ...
    desc: "Bespoke business process automation, CRM/ERP synchronization, and custom webhook engines to eliminate manual bottlenecks and scale faster.",
    accent: "#ef4444",
    visual: <AutomationVisual />,
    colSpan: "md:col-span-12 col-span-12",
  },
];
...
export default function Services() {
  ...
  return (
    <section ref={sectionRef} id="solutions" className="perf-section relative w-full bg-black px-4 py-14 sm:px-6 sm:py-18 md:px-8 md:py-20 lg:px-12 lg:py-24 scroll-mt-28" aria-labelledby="services-heading">
      ...
      <div className="mx-auto w-full max-w-7xl relative z-10">
        ...
        <div className="mb-14 sm:mb-20 text-center">
          ...
          <motion.h2 id="services-heading" initial={{ opacity: 0, y: 20 }} animate={isInView ? { opacity: 1, y: 0 } : {}} transition={{ duration: 0.6, delay: 0.1, ease: [0.16, 1, 0.3, 1] }} className="mx-auto max-w-3xl text-[clamp(28px,5vw,48px)] font-bold leading-[1.1] tracking-[-0.04em] text-white" style={{ fontFamily: '"Satoshi", sans-serif' }}>
            <span className="sr-only">AI Software Development, Custom SaaS Development, AI Workflow Automation &amp; Web Applications — Nexzoa Services</span>
          ...
          <motion.p initial={{ opacity: 0, y: 16 }} animate={isInView ? { opacity: 1, y: 0 } : {}} transition={{ duration: 0.6, delay: 0.2, ease: [0.16, 1, 0.3, 1] }} className="mx-auto mt-4 max-w-2xl text-[clamp(15px,2vw,20px)] font-medium leading-[1.4] tracking-[-0.02em] text-white/50" style={{ fontFamily: '"Satoshi", sans-serif' }}>
            End-to-end custom software engineering, AI workflow automation, SaaS platforms, and digital systems built for scale.
          </motion.p>
        </div>

...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "Ashrif Rihan Nexzoa",
    "Izzath Noory Nexzoa",
    // Brand search variations & misspellings
    "Nexz0a",
    "Nexoa",
    "Nexza",
    "Nexzo",
  ...
  authors: [
    { name: "Nexzoa", url: siteUrl("/") },
    { name: "Ashrif Rihan", url: siteUrl("/team/ashrif-rihan") },
    { name: "Izzath Noory", url: siteUrl("/team/izzath-noory") },
  ],
  creator: SITE_NAME,
  publisher: SITE_NAME,
...
export default function RootLayout({
  ...
  const organizationLd = {
    ...
    name: SITE_NAME,
    alternateName: ["Nexzoa.dev", "Nexzoa AI", "Nexzoa Software", "Nexlora"],
    url: SITE_URL,
  ...
  const websiteLd = {
    ...
    url: SITE_URL,
    name: SITE_NAME,
    alternateName: ["Nexzoa.dev", "Nexzoa AI", "Nexzoa Software Studio", "Nexzoa Studio"],
    description: SITE_DESCRIPTION_SHORT,
    publisher: {
      "@id": `${SITE_URL}/#organization`,
    },

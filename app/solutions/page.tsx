        ...
        {selectedSolutionId !== null && activeSolution && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            <motion.div
              ...
              className="relative w-full max-w-lg bg-[#0d0d0f] border border-white/[0.08] rounded-2xl p-5 sm:p-7 max-h-[85vh] flex flex-col z-10 shadow-2xl overflow-hidden"
              style={{ background: "linear-gradient(145deg, rgba(14,14,16,1) 0%, rgba(8,8,10,1) 100%)" }}
            >
              {/* Close Button */}
              <button
              ...
              <div className="overflow-y-auto pr-1 flex-1 flex flex-col gap-4 scrollbar-thin">
                {/* SVG Visual Header */}
                <div className="bg-white/[0.01] border border-white/[0.04] rounded-xl py-2 flex items-center justify-center shrink-0">
                ...
                {/* Action Buttons */}
                <div className="flex flex-col sm:flex-row gap-3 pt-3 border-t border-white/[0.06] shrink-0 mt-auto">
                  <a
                    href="mailto:hello@nexzoa.com"
